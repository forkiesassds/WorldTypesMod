...
@GuiScreenOverride(GuiCreateWorld.class)
public class GuiCreateWorldProxy extends GuiCreateWorld {
    ...
    public GuiCreateWorldProxy() {
        super(getField_22131_a((GuiCreateWorld) ModLoader.getMinecraftInstance().currentScreen));
    }
