...
public final class NoiseGeneratorPerlinIndev extends NoiseGenerator {
	private final int[] permutations;
	private final double xCoord;
	private final double yCoord;
	private final double zCoord;

	public NoiseGeneratorPerlinIndev(Random random1) {
	...
	private double generateNoise(double d1, double d3, double d5) {
		...
		d7 -= MathHelper.floor_double(d7);
		d9 -= MathHelper.floor_double(d9);
		d11 -= MathHelper.floor_double(d11);
	...
	public double generateNoiseD(double d1, double d3, double d5) {
